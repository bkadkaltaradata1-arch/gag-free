-- Perbaikan pada bagian utama kode Anda
...
    if next(oldStock) == nil then -- Cek jika ini pertama kali diinisialisasi
        isRefreshed = true
    else
...
                end
                task.wait(0.2) -- Menggunakan task.wait untuk performa lebih baik
            end
        else
...
-- Main loop for shop timer and auto-buy/sell
spawn(function()
    while true do
        -- Perbarui stok toko setiap 1 detik
...
                buyWantedCropSeeds()
                -- Tambahkan jeda setelah membeli untuk menghindari spam
                task.wait(5)
            end
        end
        
